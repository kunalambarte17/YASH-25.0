  ...
  return (
    <div className="home" id="home">
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:p-8 m-8 text-white">
        ...
        <div className="bg-black bg-opacity-70 rounded-3xl lg:p-8 p-4 "><p className="text-3xl font-extrabold ">YASH 25.0 – A Celebration of Innovation and Creativity</p><p className="text-xl mt-8">Yashwantrao Chavan College of Engineering (YCCE), Nagpur, proudly presents YASH 25.0, its highly anticipated national-
