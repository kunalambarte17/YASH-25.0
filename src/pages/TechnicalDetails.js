...
const technicalEvents = [
    ...
    { id: 2, title: "Bhairavi", description: "A soulful classical music event.", image: des2 },
    { id: 3, title: "Farzi Mushaira", description: "An evening of witty and humorous poetry.", image: des3 },
    { id: 4, title: "Fashionista", description: "A glamorous fashion show.", image: des4 },
    { id: 5, title: "Flash Mob", description: "A surprise dance performance in public.", image: des5 },
    { id: 6, title: "Focus Fest", description: "A creative photography and cinematography contest.", image: des6 },
    { id: 7, title: "Frame by Frame", description: "A short film and animation screening event.", image: des7 },
    { id: 8, title: "Freshers Welcome", description: "A special event to welcome new students.", image: des8 },
    { id: 9, title: "Jashn", description: "A cultural extravaganza celebrating diversity.", image: des9 },
    { id: 10, title: "Megheshree", description: "A traditional Indian dance competition.", image: des10 },
    { id: 11, title: "Mini OG Vlogverse", description: "A short storytelling vlog competition.", image: des11 },
    { id: 12, title: "Muktswar", description: "A powerful solo singing competition.", image: des12 },
    { id: 13, title: "Open Mic", description: "A free platform for spoken word, poetry, and comedy.", image: des13 },
