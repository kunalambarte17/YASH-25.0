...
import cards from '../pages/TechnicalDetails'; // Import the updated card data
import {Link } from "react-router-dom";

const Technicalcontain = () => {
    ...
    <div className=" mx-auto p-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
        {cards.map((card) => (
          ...
          >
             <Link className="anchor-link" to={`/Technicalviewsingle/${card.id}`}>
...
export default Technicalcontain;
