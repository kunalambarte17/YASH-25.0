...
const sportEvents = [
    ...
    { id: 9, title: "Commando Room || 14TH Feb ", description: "Commando Room is an exciting event inspired by the SSB interview process, designed to test focus, problem-solving, and decision-making under challenging conditions. The event features two rounds that blend creativity, analytical thinking, and psychological evaluation.", image: des9 ,link : "https://forms.gle/prHMUvWswimDqkrt8"},
